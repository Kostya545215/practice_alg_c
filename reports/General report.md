...
slowtimemachine - симуляция на ПК всех процессов и модели трехфазного инвертора. Полная модель с формированием ШИМ сигналов, перенаправлением их в ключи, отображением графиков на ПК.
